...
The data sets are stored in [comma-separated values](http://software-carpentry.org/v5/gloss.html#csv) (CSV) format:
...
even more live in the [libraries](http://software-carpentry.org/v5/gloss.html#library) they are used to build.

In order to load our inflammation data,
we need to [import](http://software-carpentry.org/v5/gloss.html#import) a library called NumPy. In general you should use this library if you want to do fancy things with numbers, especially if you have matrices. We can load NumPy using:
...
The expression `numpy.loadtxt(...)` is a [function call](http://software-carpentry.org/v5/gloss.html#function-call)
that asks Python to run the function `loadtxt` that belongs to the `numpy` library.
This [dotted notation](http://software-carpentry.org/v5/gloss.html#dotted-notation) is used everywhere in Python
to refer to the parts of things as `thing.component`.

`numpy.loadtxt` has two [parameters](http://software-carpentry.org/v5/gloss.html#parameter):
the name of the file we want to read,
and the [delimiter](http://software-carpentry.org/v5/gloss.html#delimiter) that separates values on a line.
These both need to be character strings (or [strings](http://software-carpentry.org/v5/gloss.html#string) for short),
...
To do that,
we need to [assign](http://software-carpentry.org/v5/gloss.html#assignment) the array to a [variable](http://software-carpentry.org/v5/gloss.html#variable).
...
First,
let's ask what [type](http://software-carpentry.org/v5/gloss.html#data-type) of thing `data` refers to:
...
We can see what its [shape](http://software-carpentry.org/v5/gloss.html#shape) is like this:
...
`data.shape` is a [member](http://software-carpentry.org/v5/gloss.html#member) of `data`,
i.e.,
...
we must provide an [index](http://software-carpentry.org/v5/gloss.html#index) in square brackets,
...
The [slice](http://software-carpentry.org/v5/gloss.html#slice) `0:4` means,
...
`mean` is a [method](http://software-carpentry.org/v5/gloss.html#method) of the array,
i.e.,
...
A subsection of an array is called a [slice](http://software-carpentry.org/v5/gloss.html#slice).
...
1.  The expression `element[3:3]` produces an [empty string](http://software-carpentry.org/v5/gloss.html#empty-string),
...
<div class="out">
<img src="2015-03-06-nyas/lessons/python/01-numpy_files/novice/python/01-numpy_71_0.png">
</div>
...
<div class="out">
<img src="2015-03-06-nyas/lessons/python/01-numpy_files/novice/python/01-numpy_73_0.png">
</div>
...
<img src="2015-03-06-nyas/lessons/python/01-numpy_files/novice/python/01-numpy_75_1.png">
<pre class='out'><code>minimum inflammation per day
</code></pre>
<img src="2015-03-06-nyas/lessons/python/01-numpy_files/novice/python/01-numpy_75_3.png">
</div>
...
It's very common to create an [alias](http://software-carpentry.org/v5/gloss.html#alias) for a library when importing it
...
<div class="out">
<img src="2015-03-06-nyas/lessons/python/01-numpy_files/novice/python/01-numpy_80_0.png">
</div>
