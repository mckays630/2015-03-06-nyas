...
The [body](http://software-carpentry.org/v5/gloss.html#function-body) of the function&mdash;the
...
Inside the function,
we use a [return statement](http://software-carpentry.org/v5/gloss.html#return-statement) to send a result back to whoever asked for it.
...
as [integers](http://software-carpentry.org/v5/gloss.html#integer)
or as [floating-point numbers](http://software-carpentry.org/v5/gloss.html#float-point-number) (or floats).
...
Instead,
we can [compose](http://software-carpentry.org/v5/gloss.html#function-composition) the two functions we have already created:
...
Instead,
it creates something called a [stack frame](http://software-carpentry.org/v5/gloss.html#stack-frame)
...
The big idea here is [encapsulation](http://software-carpentry.org/v5/gloss.html#encapsulation),
...
we should write some [documentation](http://software-carpentry.org/v5/gloss.html#documentation) for our function
to remind ourselves later what it's for and how to use it.

The usual way to put documentation in software is to add [comments](http://software-carpentry.org/v5/gloss.html#comment) like this:
...
A string like this is called a [docstring](http://software-carpentry.org/v5/gloss.html#docstring).
...
in which case `desired` is automatically assigned the [default value](http://software-carpentry.org/v5/gloss.html#default-parameter-value) of 0.0:
...
*   Each time a function is called, a new stack frame is created on the [call stack](http://software-carpentry.org/v5/gloss.html#call-stack) to hold its parameters and local variables.
